...
//
// Original source of this file is 'cpu/arith64.cc'.
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::SBB_EqGqM(bxInstruction_c *i)
{
  ...
  write_linear_qword(i->seg(), get_laddr64(i->seg(), eaddr), diff_64);
...
BX_INSF_TYPE BX_CPP_AttrRegparmN(1) BX_CPU_C::NEG_EqM(bxInstruction_c *i)
{
  ...
  write_linear_qword(i->seg(), get_laddr64(i->seg(), eaddr), op1_64);
