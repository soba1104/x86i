...
//
// Original source of this file is 'cpu/fpu/fpu.cc'.
...
/////////////////////////////////////////////////////////////////////////////////
// 変更点
// "iodev/iodev.h" の include を削除
// DEV_pic_raise_irq と fprintf の定義を適当に置き換える
...
#define DEV_pic_raise_irq(dummy) assert(false);
#define fprintf(...)
